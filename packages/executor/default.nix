...
let
  sources = {
    "x86_64-linux" = {
      platform = "linux";
      architecture = "x64";
      hash = "sha512-2GyuJ8kDE6fFDRGxEuTXD7hB/+tIX7ip0M0YLnkZiIMfi+Gfa4x6S5FFK1/9SW5Qn7YGlAu88X1K12/iD4Ntfw==";
    };
    "aarch64-linux" = {
      platform = "linux";
      architecture = "arm64";
    ...
    "aarch64-darwin" = {
      platform = "darwin";
      architecture = "arm64";
      hash = "sha512-0kYoIa27cN3H3el9F7OCe5o/EeCuo1kVRyIDz8OBjglkgVFEX4uTfHmCTbyrdTJmxxawvy4UWD31RvncL0ZKbw==";
    };
  };
